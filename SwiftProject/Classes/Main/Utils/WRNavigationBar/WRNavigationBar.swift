...
let STATUS_BAR = UIApplication.shared.windows.first?.windowScene?.statusBarManager
/// 状态栏高度
let STATUS_HEIGHT = STATUS_BAR_MANAGER!.statusBarFrame.size.height;

/// 导航栏高度
let BAR_HEIGHT = STATUS_BAR_HEIGHT + 44
